...
// // File Path: src/app/dashboard/products/new/page.js
// 'use client';
...
// // ====== Access Denied Component (Aap isay ek alag file mein bhi rakh sakte hain) ======
// const AccessDenied = () => {
...
//             <p className="text-lg text-gray-600 mt-2">You must be an Administrator to add new products.</p>
//             <button
...
const AccessDenied = () => {
    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-[70vh] text-center p-4 sm:p-6">
            ...
            <p className="text-base sm:text-lg text-gray-600 mt-2">You must be an Administrator to add new products.</p>
            <button
                onClick={() => router.push('/dashboard')}
                className="mt-4 sm:mt-6 px-4 sm:px-6 py-2 bg-blue-600 text-white font-semibold rounded-lg hover:bg-blue-700 transition-colors"
            >
                Return to Dashboard
            </button>
        </div>
  ...
  return (
    <div className="p-4 sm:p-6 bg-gray-50 min-h-screen">
      <div className="flex items-center mb-4 sm:mb-6">
        <button 
          onClick={() => router.back()} 
          className="p-1.5 sm:p-2 rounded-full hover:bg-gray-200 mr-2 sm:mr-4 transition-colors"
          aria-label="Go back"
        >
      ...
      <div className="bg-white p-4 sm:p-6 md:p-8 rounded-lg sm:rounded-xl shadow-sm sm:shadow-md">
        ...
        <ProductForm 
          ...
          submitButtonClass="w-full sm:w-auto px-4 sm:px-6 py-2 bg-green-600 hover:bg-green-700 text-white font-medium rounded-lg transition-colors"
        />
      </div>
    </div>
  );
